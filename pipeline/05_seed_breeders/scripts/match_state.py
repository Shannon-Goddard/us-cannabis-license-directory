"""
Pipeline 05 — Breeder vs State Slug Match
Matches breeders-clean.csv slug against state-verified.csv slug and dba_slug.
...
STATE    = os.path.join(BASE, "../input/state-verified.csv")
...
# Load state — build lookup by slug and dba_slug
...
for b in breeders:
    ...
    # Check dba_slug match (only if not already matched via slug)
